...
elseif(APPLE)
    ...
    add_compile_definitions(COREMIDI_BACKEND)
    add_compile_definitions(COREAUDIO_BACKEND)
    add_compile_definitions(GLFW_BACKEND)
    set(MAYAFLUX_WINDOWING_BACKEND "GLFW_BACKEND" CACHE INTERNAL "")
    set(MAYAFLUX_AUDIO_BACKEND "COREAUDIO_BACKEND" CACHE INTERNAL "")
    set(MAYAFLUX_MIDI_BACKEND "COREMIDI_BACKEND" CACHE INTERNAL "")
elseif(UNIX)
    ...
    option(MAYAFLUX_LINUX_USE_GLFW
           "Use GLFW windowing backend on Linux instead of native Wayland" OFF)

    if(MAYAFLUX_LINUX_USE_GLFW)
        add_compile_definitions(GLFW_BACKEND)
        set(MAYAFLUX_WINDOWING_BACKEND "GLFW_BACKEND" CACHE INTERNAL "")
    else()
