...
brew install cmake rtaudio molten-vk ffmpeg googletest pkg-config eigen onedpl magic_enum fmt glfw
...
MISSING_PACKAGES=""
for pkg in cmake rtaudio molten-vk glfw ffmpeg googletest pkg-config eigen onedpl magic_enum fmt; do
...
echo "  ✓ CMake, Molten-vk, RtAudio, FFmpeg, GoogleTest, GLFW"
