...
set(GLFW_LIBRARY "C:/Program Files/GLFW/lib-vc2022/glfw3dll.lib" CACHE FILEPATH "" FORCE)
set(GLFW_DLL "C:/Program Files/GLFW/lib-vc2022/glfw3.dll" CACHE FILEPATH "" FORCE)
