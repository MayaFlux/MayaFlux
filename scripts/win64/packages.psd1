@{
    ...
    BinaryPackages = @{
        LLVM = @{
            Version      = "22.1.6"
            InstallRoot  = "C:\Program Files\LLVM_Libs\22.1.6"
            Url          = "https://github.com/llvm/llvm-project/releases/download/llvmorg-22.1.6/clang+llvm-22.1.6-x86_64-pc-windows-msvc.tar.xz"
            Verify       = "C:\Program Files\LLVM_Libs\22.1.6\lib\LLVMCore.lib"
        }
    }
