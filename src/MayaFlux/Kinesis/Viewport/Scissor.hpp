 ...
 * Mapped<T>, Collapsible, Scrollable, Entry, EntryGroup, and so on)
...
struct Scissor {
    ...
    /// @brief Construct from anything exposing bounds(): Mapped<T>, Collapsible, Scrollable, Entry, EntryGroup, and so on.
