...
/**
 * @brief Render a UTF-8 string into a TextBuffer ready for display.
 *
 ...
 * TextBuffer.
 *
 * The returned TextBuffer uses the default texture.vert.spv /
 ...
 * @return            Initialized TextBuffer, or nullptr if text is empty
 *                    or no glyphs could be laid out.
 */
[[nodiscard]] std::shared_ptr<Buffers::TextBuffer> render_text(
