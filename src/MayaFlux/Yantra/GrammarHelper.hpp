...
/**
 * @brief Create an operation instance with parameters using your existing safe_any_cast system
 */
...
/**
 * @brief Apply context parameters to an operation using your existing patterns
 */
