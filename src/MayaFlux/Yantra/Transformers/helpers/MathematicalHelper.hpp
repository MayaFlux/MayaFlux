 ...
 */
template <ComputeData DataType>
DataType transform_linear(DataType& input, double a, double b, std::vector<double>& working_buffer)
{
 ...
 */
template <ComputeData DataType>
DataType transform_polynomial(DataType& input, const std::vector<double>& coefficients, std::vector<double>& working_buffer)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
 ...
 */
template <ComputeData DataType>
DataType transform_exponential(DataType& input, double a, double b, std::vector<double>& working_buffer, double base = std::numbers::e)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
 ...
 */
template <ComputeData DataType>
DataType transform_logarithmic(DataType& input, double a, double b, double c, std::vector<double>& working_buffer, double base = std::numbers::e)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
 ...
 */
template <ComputeData DataType>
DataType transform_clamp(DataType& input, double min_val, double max_val, std::vector<double>& working_buffer)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
 ...
 */
template <ComputeData DataType>
DataType transform_wrap(DataType& input, double wrap_range, std::vector<double>& working_buffer)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
...
DataType transform_normalize(DataType& input, const std::pair<double, double>& target_range = { -1.0, 1.0 })
{
    ...
    auto [min_it, max_it] = std::ranges::minmax_element(target_data);
 ...
 */
template <ComputeData DataType>
DataType transform_normalize(DataType& input, const std::pair<double, double>& target_range, std::vector<double>& working_buffer)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
 ...
 */
template <ComputeData DataType>
DataType interpolate_linear(DataType& input, size_t target_size, std::vector<double>& working_buffer)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);

    if (target_size == target_data.size()) {
        return input;
    }
 ...
 */
template <ComputeData DataType>
DataType interpolate_cubic(DataType& input, size_t target_size, std::vector<double>& working_buffer)
{
    auto [target_data, structure_info] = OperationHelper::setup_operation_buffer(input, working_buffer);
    ...
    std::ranges::transform(indices, working_buffer.begin(),
        [&target_data, target_size](size_t i) {
            ...
            auto get_sample = [&target_data](int i) {
                return target_data[std::clamp(i, 0, static_cast<int>(target_data.size() - 1))];
            };
