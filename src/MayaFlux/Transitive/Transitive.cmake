...
set(TRANSITIVE_SOURCES_MT ${TRANSITIVE_SOURCES})
list(REMOVE_ITEM TRANSITIVE_SOURCES_MT
    "${CMAKE_CURRENT_LIST_DIR}/Memory/LiveArena.cpp"
)
...
if(WIN32)
    ...
    add_library(Transitive_MT OBJECT ${TRANSITIVE_SOURCES_MT} ${TRANSITIVE_HEADERS})
